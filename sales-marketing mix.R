###A linear regression model that will predict the effectiveness of different marketing channels on sales of a product###

##Import data in R
setwd("C:\\Documents\\Linear Regression")
...
#Value =1/0 variable :presence /absence of Sales
